...
import { MessageSquare, Calendar, CreditCard, Phone, Video, FileText, MessageCircle, BadgeCheck } from "lucide-react"
...
const integrations: Integration[] = [
  {
    ...
    description: "Send appointment reminders, confirmations, and communicate with patients via WhatsApp.",
  ...
  },
  {
    ...
    description: "Sync appointments automatically with Google Calendar for seamless schedule management.",
    category: ["Scheduling"],
  ...
  },
  {
    id: "stripe",
    name: "Stripe",
    description: "Accept payments securely with Stripe. Process credit cards, invoices, and subscriptions.",
    category: ["Payments"],
  ...
  },
  {
    id: "twilio",
    name: "Twilio",
    description: "Send SMS reminders and notifications to patients for appointments and follow-ups.",
    category: ["Communication"],
  ...
  },
  {
    id: "zoom",
    name: "Zoom",
    description: "Conduct virtual consultations with integrated Zoom video conferencing.",
    category: ["Communication"],
  ...
  },
  {
    id: "quickbooks",
    name: "QuickBooks",
    description: "Sync financial data and automate accounting with QuickBooks integration.",
    category: ["Payments"],
  ...
  },
  {
    id: "slack",
    name: "Slack",
    description: "Get real-time notifications and collaborate with your team using Slack.",
    category: ["Communication"],
    icon: <MessageCircle className="w-8 h-8" />,
  },
]

const categories: IntegrationCategory[] = ["All", "Communication", "Payments", "Scheduling"]
