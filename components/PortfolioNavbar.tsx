      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center gap-4">
            ...
            <Link href="/signup" className="btn-primary rounded-full text-base">
              Sign Up
            </Link>
          </div>
            ...
            <div className="px-6 py-6 space-y-4">
              {navigationLinks.map((link) => (
                <Link
                  ...
                  className="block text-foreground hover:text-[#0A8FDC] py-3 text-lg font-medium transition-colors duration-200"
                >
                  <span>{link.name}</span>
                </Link>
              ))}
