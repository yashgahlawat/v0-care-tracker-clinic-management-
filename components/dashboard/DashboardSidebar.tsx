    ...
    <>
      ...
      >
        <div className="h-20 flex items-center justify-between px-4 border-b border-gray-100">
          ...
          <button onClick={onToggle} className="p-2 rounded-lg hover:bg-gray-100 text-gray-500 transition-colors">
          ...
          {menuItems.map((item) => (
            <Link
              ...
              className={`flex items-center gap-3 px-3 py-3 rounded-xl transition-all duration-200 group ${
                item.active ? "bg-[#0A8FDC] text-white" : "text-gray-600 hover:bg-gray-100 hover:text-[#0A8FDC]"
              }`}
            >
