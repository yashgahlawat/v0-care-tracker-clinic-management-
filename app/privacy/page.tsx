...
export const metadata: Metadata = {
  ...
  description:
    "CareTracker Privacy Policy - Learn how we protect your data and maintain HIPAA compliance.",
};
        ...
        <div className="space-y-8 text-[#444444]">
          <section>
            ...
            <p className="leading-relaxed">
              ...
              email address, organization details, and any other information you
              choose to provide when using our clinic management platform.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              CareTracker is fully HIPAA compliant. We implement administrative,
              physical, and technical safeguards to protect all Protected Health
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              protect your data. All data is encrypted at rest and in transit
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              contact us at privacy@caretracker.com or visit our Contact page.
            </p>
          </section>
        </div>
      </div>
